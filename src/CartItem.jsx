            ...
            <div className="card item-card">
                ...
                <div className="card-body">
                    ...
                    <p>Quantity <span className="item-quantity">{this.props.item.quantity}</span>
                        ...
                        <span><button className="item-plus-button btn btn-light" onClick={() => { this.props.decreaseQuantity(this.props.item) }}>-</button></span>
                        <span><button className="item-minus-button btn btn-light" onClick={() => { this.props.increaseQuantity(this.props.item) }}>+</button></span>
                    </p>
